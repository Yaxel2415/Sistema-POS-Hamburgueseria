        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="categoria-card">
                    ...
                    <a href="{{ route('hamburguesas.index') }}" class="btn-categoria">Explorar</a>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="categoria-card">
                    ...
                    <a href="{{ route('combos.index') }}" class="btn-categoria">Ver Combos</a>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="categoria-card">
                    ...
                    <a href="{{ route('complementos.index') }}" class="btn-categoria">Ver Acompañamientos</a>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="categoria-card">
                    ...
                    <a href="{{ route('bebidas.index') }}" class="btn-categoria">Ver Bebidas</a>
                </div>
            </div>
...
<div class="col-md-4">
    <div class="categoria-card">
        ...
        <a href="{{ route('armar') }}" class="btn-categoria">Comenzar</a>
    </div>
</div>
            ...
            <div class="col-md-4">
                <div class="categoria-card">
                    ...
                    <a href="{{ route('carrito.index') }}" class="btn-categoria">Crear Orden</a>
                </div>
            </div>
        </div>
