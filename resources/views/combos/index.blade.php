...
<div class="combos-container">
    ...
    {{-- ✅ Combos en oferta --}}
    <div class="header-combos" style="margin-top:60px;">
...
<div class="btn-container">
    <a href="{{ route('sugerencias.index') }}" class="btn-volver">
        <img src="{{ asset('assets/icons/black2.png') }}" alt="Carrito" style="width:35px;height:35px;">
        Regresar
    </a>
</div>
@endsection
