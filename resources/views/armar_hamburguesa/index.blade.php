...
<div class="burger-builder-container">
  ...
  <span style="color: #d3b860ff; font-size:37px; font-weight: bold;">🍔 ARMA TU</span>
  <span style="color: #ffffffff; font-size:37px; font-weight: bold; margin-left: 10px;">HAMBURGUESA</span>
</div>
...
@endforeach
    ...
    <div class="burger-preview">
        ...
        <form id="formCarrito" action="{{ route('carrito.agregar') }}" method="POST">
            @csrf
