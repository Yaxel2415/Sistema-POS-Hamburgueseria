...
<div class="carrito-container">
   ...
   <span style="color: #d3b860ff; font-size:50px;">🛒 TU ORDEN</span> <span style="color: #ffffffff;font-size:50px;">PERFECTA</span>
    ...
    <a href="{{ route('catalogo.index') }}" class="btn-seguir"><img src="{{ asset('assets/icons/black2.png') }}" alt="Icono" style="height: 27px; vertical-align: middle; margin-right: 8px;">
  Seguir comprando
</a>
    ...
    <tbody>
        ...
        @foreach($carrito as $index => $item)
            <tr>
                ...
                <!-- ELIMINAR -->
                <td>
                    <form action="{{ url('/carritoCliente/quitar/'.$index) }}" method="POST">
                        @csrf
        ...
        <div class="total">
            ...
            <form action="{{ route('carritoCliente.confirmar') }}" method="POST">
             @csrf
            ...
            <a href="{{ route('menucliente') }}" class="btn-menu"><img src="{{ asset('assets/icons/casa.png') }}" alt="Icono" style="height: 27px; vertical-align: middle; margin-right: 8px;">
