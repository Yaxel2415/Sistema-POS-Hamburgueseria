...
<head>
    ...
    <title>Editar Usuario - Hamburguesería</title>
...
<body>
    ...
    <div class="container">
        <h2 class="text-center">✏️ Editar Usuario</h2>
        ...
        <form action="{{ route('usuario.update', $usuario->id) }}" method="POST">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="id_usuario" class="form-control" value="{{ $usuario->id_usuario }}" required>
                </div>
                <div class="form-group">
                    <label>Usuario</label>
                ...
                <div class="form-group">
                    ...
                    <div class="password-note">⚠️ Dejar vacío si no deseas cambiar la contraseña</div>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="Ap_Materno" class="form-control" value="{{ $usuario->Ap_Materno }}" required>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="numero_tel" class="form-control" value="{{ $usuario->numero_tel }}" required>
                </div>
            ...
            <div class="botones-container">
                ...
                <a href="{{ route('usuario.index') }}" class="btn btn-secondary text-decoration-none">❌ Cancelar</a>
            </div>
        </form>
    </div>
</body>
