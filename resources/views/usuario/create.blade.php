...
<head>
    ...
    <title>Agregar Usuario - Hamburguesería</title>
        ...
        <form action="{{ route('usuario.store') }}" method="POST">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="id_usuario" class="form-control" value="{{ old('id_usuario') }}" required>
                </div>
                <div class="form-group">
                    <label>Usuario</label>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="numero_tel" class="form-control" value="{{ old('numero_tel') }}" required>
                </div>
